---
name: DataAnalyst
description: Data analysis agent for the DSL KidsGPT Prolific study. Exports, loads, and analyzes participant data from moderation sessions, child profiles, assignment timings, and exit-survey responses.
---
