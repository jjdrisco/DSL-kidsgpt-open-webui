---
name: SurveyScenarioReview
description: Covers the survey scenario review feature — scenario assignment, the 2-step moderation flow (highlight + concern rating), attempt tracking, reset, and finalization.
---
