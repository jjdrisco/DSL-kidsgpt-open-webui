...
app.state.config.ENABLE_SUGGESTION_GENERATION = ENABLE_SUGGESTION_GENERATION
...
app.state.config.SUGGESTION_GENERATION_PROMPT_TEMPLATE = (
    SUGGESTION_GENERATION_PROMPT_TEMPLATE
)
            ...
            **(
                {
                    ...
                    "enable_suggestion_generation": app.state.config.ENABLE_SUGGESTION_GENERATION,
