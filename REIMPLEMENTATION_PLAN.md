...
export function getStepRoute(step: number): string {
    switch (step) {
        ...
        default: return '/assignment-instructions';
    }
}
...
export function getStepLabel(step: number): string {
    switch (step) {
        case 1: return 'Child Profile';
        case 2: return 'Moderation';
        case 3: return 'Exit Survey';
        case 4: return 'Completion';
...
<script lang="ts">
    ...
    function getStepInfo(step: number) {
        ...
        if (step === 1) {
            ...
            isCompleted = workflowProgress.progress_by_section.moderation_completed_count >= 
