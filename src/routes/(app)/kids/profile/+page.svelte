		...
		<div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8">
			<form on:submit|preventDefault={saveChildProfile} class="space-y-6">
				...
				<div class="space-y-6">
					...
					<!-- Personality traits moved to the end of the form -->
			...
			<div class="pt-2">
				...
				<!-- Personality Traits Selection - now at the end -->
				<div class="mt-8">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Personality Traits <span class="text-red-500">*</span>
                    </label>
					<p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
						(After core details) Select traits and characteristics that describe your child.
					</p>
