---
name: whitelist
description: Child whitelist enforcement context — use when working on child content filtering, whitelist configuration, the middleware enforcement pipeline, or the parent whitelist UI.
