...
description: Covert attention check system context — use when working on attention check behavior, the AttentionCheckBar component, or the attention-code PATCH endpoint.
